...
OUT_CSV = Path("outputs/metrics/final_comparison_with_ssl.csv")
OUT_MD = Path("outputs/metrics/final_comparison_with_ssl.md")
...
ROWS = [
    ...
    {
        "model": "Wav2Vec2 SSL Transformer",
        "features": "Raw waveform SSL embeddings",
        "test_set": "Balanced 800-sample subset",
        "accuracy": 0.75125,
        "macro_f1": 0.74581,
        "stutter_recall": 0.6050,
        "fluent_specificity": 0.8975,
        "stutter_f1": 0.70864,
        "fluent_f1": 0.78299,
        "threshold": 0.50,
    },
...
def main():
    ...
    lines = []
    lines.append("# Final Model Comparison Including SSL Transformer")
    lines.append("")
    lines.append("| Model | Features | Test Set | Accuracy | Macro-F1 | Stutter Recall | Fluent Specificity | Stutter F1 | Fluent F1 | Threshold |")
    lines.append("|---|---|---|---:|---:|---:|---:|---:|---:|---:|")
