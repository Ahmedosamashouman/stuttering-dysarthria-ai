...
W2V_PREDS = Path("outputs/predictions/wav2vec2_ssl_bigger_claude_test_predictions.csv")
WAVLM_PREDS = Path("outputs/predictions/wavlm_frozen_bigger_test_predictions.csv")

OUT_CSV = Path("outputs/metrics/high_confidence_screening_claude_test_search.csv")
OUT_MD = Path("outputs/metrics/high_confidence_screening_claude_test_search.md")
